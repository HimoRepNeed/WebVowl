//import { Vowl, Class, ClassAttribute } from '.././model/vowl.interface'
import { BaseNode } from './elements/nodes/baseNode';
import { NodeFactory } from './elements/nodes/nodePrototypeMap';
import { PropertyFactory } from './elements/properties/propertyPrototypeMap';
...
export class Parser {
        ...
        if (baseObject) {
            ...
            angular.forEach(baseObject, function (c) {
                ...
                if (attributes) {
                    ...
                    var node = NodeFactory.GetNode(Parser.graph, c.type.toLowerCase());
    ...
    private static mergeRangesOfEquivalentProperties = (properties, nodes) => {
        ...
        let newNodes = EquivalentPropertyMerger.merge(properties.slice(), nodes.slice(), Parser.propertyMap, Parser.classMap, Parser.graph);
    ...
    private static combineProperties = (baseObjects: any, attributes: any) => {
        ...
        if (baseObjects) {
            baseObjects.forEach(function (element: any) {
                ...
                //TODO use Factory
                var property = PropertyFactory.GetProperty(Parser.graph, element.type.toLowerCase());
